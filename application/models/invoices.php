    ...
    public function store(){
        if($this->input->post('method') == 'COD'){
            $data = array(
                ...
                'origin'        => 'Sukapura, Bandung, West Java, Indonesia',
                'origin_id'     => 'ChIJQXjDl6zpaC4RuiyZXIf658I',
                //'origin_id'     => $this->input->post('origin-place_id'),
                //'destination'   => $this->input->post('destination'),
                //'destination_id'=> $this->input->post('destination-place_id'),
                'destination'   => 'Telkom University, Jalan Telekomunikasi Jl. Terusan Buah Batu, Sukapura, Kota Bandung, Jawa Barat, Indonesia',
                'destination_id'=> 'ChIJF6V9W1wo1i0RlY84avKFRIY',

    		...
    		<div class="row justify-content-center">
    			<div class="col-md-10 mb-5 text-center">
    				<ul class="product-category">
    					<li><a href="<?php echo site_url('category') ?>">All</a></li>
                    <?php foreach ($categories as $category): ?>
    					<li><a href="<?php echo site_url('category/show/').$category['id'] ?>" <?php if($id == $category['id']){echo 'class="active"';} ?> ><?php echo $category['name'] ?></a></li>
                    <?php endforeach; ?>
    				</ul>
    			</div>
    		</div>

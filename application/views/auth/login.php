...
<head>
    ...
    <!-- Plugin CSS Files -->
    <link rel="stylesheet" href="<?php echo base_url('assets_user/') ?>css/plugin/swiper.min.css">
    <link rel="stylesheet" href="<?php echo base_url('assets_user/') ?>css/plugin/material-scrolltop.css">
                        ...
                        <div class="col-12">
                            <div class="header__top-content">
                                ...
                                <div class="header__top-content--right">
                                    ...
                                    <div class="user-info user-set-role">
                                        <a class="user-set-role__button" href="#" data-toggle="dropdown" aria-haspopup="true"> <img src="<?php echo base_url('assets_user/') ?>img/icon/flag/icon_usa.png" alt="">USA <i class="fal fa-chevron-down"></i></a>
                                        <ul class="expand-dropdown-menu dropdown-menu">
                                            <li><a href="#"><img src="<?php echo base_url('assets_user/') ?>img/icon/flag/icon_usa.png" alt="">English</a></li>
                                            <li><a href="#"><img src="<?php echo base_url('assets_user/') ?>img/icon/flag/icon_france.png" alt=""> Français</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <ul class="mega-menu pos-absolute">
                                        ...
                                        <li class="mega-menu__banner">
                                            <a href="shop-1.html" class="mega-menu__banner-link">
                                                <img src="<?php echo base_url('assets_user/') ?>img/banner/menu-banner.jpg" alt="" class="mega-menu__banner-img">
                                            </a>
                                        </li>
                                        <!--Megamenu Item Banner-->
                                    </ul>
            ...
            <div class="offcanvas-inner">
                <div class="offcanvas-userpanel m-b-30">
                    <ul>
                        ...
                        <li class="offcanvas-userpanel__role">
                            <a href="#"><img src="<?php echo base_url('assets_user/') ?>img/icon/flag/icon_usa.png" alt="">English </a>
                            <ul class="user-sub-menu">
                                <li><a href="#"><img src="<?php echo base_url('assets_user/') ?>img/icon/flag/icon_usa.png" alt="">English</a></li>
                                <li><a href="#"><img src="<?php echo base_url('assets_user/') ?>img/icon/flag/icon_france.png" alt=""> Français</a></li>
                            </ul>
            ...
            <ul class="offcanvas-add-cart__menu">
                ...
                <li class="offcanvas-add-cart__list pos-relative">
                    <div class="offcanvas-add-cart__img-box pos-relative">
                        <a href="single-1.html" class="offcanvas-add-cart__img-link img-responsive"><img src="<?php echo base_url('assets_user/') ?>img/product/size-small/product-home-1-img-1.jpg" alt="" class="add-cart__img"></a>
                ...
                <li class="offcanvas-add-cart__list pos-relative">
                    <div class="offcanvas-add-cart__img-box pos-relative">
                        <a href="single-1.html" class="offcanvas-add-cart__img-link img-responsive"><img src="<?php echo base_url('assets_user/') ?>img/product/size-small/product-home-1-img-2.jpg" alt="" class="add-cart__img"></a>

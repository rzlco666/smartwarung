<footer class="">
  <div class="container">
    <!-- <div class="row">
      <div class="mouse">
        <a href="#" class="mouse-icon float-right" style="margin-right: 10%;">
    ...
    <div class="row text-center">
      <div class="col-md">
        <div class="ftco-footer-widget">
          <h2 class="ftco-heading-2">SmartWarung</h2>
      ...
      <div class="col-md">
        <div class="ftco-footer-widget ml-md-5">
          ...
          <ul class="list-unstyled">
            <li><a href="<?php echo site_url('home') ?>" class="py-2 d-block">Beranda</a></li>
            <li><a href="<?php echo site_url('category') ?>" class="py-2 d-block">Kategori</a></li>
            <li><a href="#contact_usss" class="py-2 d-block">Hubungi Kami</a></li>
          </ul>
        </div>
      </div>
      <!-- <div class="col-md-4">
      ...
      <div class="col-md">
        <div class="ftco-footer-widget">
          <h4 class="ftco-heading-2">Perlu bantuan atau ada kendala?</h4>
          <!-- <div class="block-23 mb-3"> -->
          <div class="text-center">
            <a href="https://wa.me/" target="_blank">
              <svg height="30pt" viewBox="-1 0 512 512" width="30pt" xmlns="http://www.w3.org/2000/svg">

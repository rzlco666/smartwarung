...
<section class="ftco-section">
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-10 mb-5 text-center">
                <ul class="product-category">
                    <li><a href="<?php echo site_url('profile/etalase/' . $this->session->username) ?>">All</a></li>
                    <?php foreach ($categories as $category) : ?>
                        <li><a href="<?php echo site_url('profile/etalase_warung/') . $category['id'] ?>" <?php if ($id == $category['id']) {
                                                                                                                echo 'class="active"';
        ...
        <div class="row">
                    <div class="col-md-12 ftco-animate">
                        ...
                        <?php if ($user['username'] == $this->session->userdata('username') or $this->session->userdata('role') == 99) : ?>
                            <td class="price"><?php if ($item['hide'] == 1) {
                                                    echo "Tidak Tampil";
                                                } else {
                                                    echo "Tampil";
                                                } ?>
